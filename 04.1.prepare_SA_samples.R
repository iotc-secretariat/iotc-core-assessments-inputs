...
prepare_SA_samples_FIA_Q = function(raised_catches, size_frequency_samples) {
  ...
  print("### Samples FI_YQ ###")
  print("")
  print(paste0("Original no. samples: ", SF_SAMPLES_NO))
  print(paste0("No. samples         : ", SA_samples_FIA_Q_SA))
  print(paste0("Difference          : ", SF_SAMPLES_NO - SA_samples_FIA_Q_SA))
  ...
  print("")
  print("### Est. weight FI_YQ ###")
  print("")
  print(paste0("Original est. weight: ", CE_RAISED_MT))
  print(paste0("Est. weight         : ", SA_samples_FIA_Q_MT))
  print(paste0("Difference          : ", CE_RAISED_MT - SA_samples_FIA_Q_MT))
  ...
  print("")
  print("### Est. number FI_YQ ###")
  print("")
  print(paste0("Original est. number: ", CE_RAISED_NO))
  print(paste0("Est. number         : ", SA_samples_FIA_Q_NO))
  print(paste0("Difference          : ", CE_RAISED_NO - SA_samples_FIA_Q_NO))
