...
FG_TO_SA_AREAS_ORIGIN_REV = query(DB_IOTC_MASTER(), "SELECT TARGET_CODE AS TARGET_FISHING_GROUND_CODE, SOURCE_CODE AS FISHING_GROUND_CODE, SOURCE_REL_INTERSECTION AS PROPORTION FROM refs_gis.AREA_INTERSECTIONS WHERE TARGET_CODE LIKE 'SA_BET_%' AND SUBSTRING(SOURCE_CODE, 1, 1) IN ('5', '6');")
